...
$id = $_GET['id'];
$ress=mysqli_query($con,"select * from lead where id='$id'");
...
$sql="update lead set  name='$name',email='$email',phone='$phone',address='$address',businessname='$businessname',notes='$notes',remark='$remark'  where id='$id'";
$result=mysqli_query($con,$sql);

if($result=mysqli_query($con,$sql)==1)
{
    echo "<script>alert('Updated');</script>";
    echo "<script>window.location.href='Lead';</script>";
                                     ...
                                     <div class="row">
                                       <div class="col-md-4">
                                           <div id="form-group-name" class="form-group  ">
                                             ...
                                             <input   type="text" name="name" value="<?php echo $rowclientclient['name'];?>"  class="form-control form-control" placeholder="Client's Name"   >
                                          </div>
                                         </div>
                                         ...
                                         <div class="col-md-4">
                                          <div id="form-group-name" class="form-group  ">
                                             ...
                                             <input  type="text" name="email" value="<?php echo $rowclientclient['email'];?>"  class="form-control form-control" placeholder="Email Address"   >
                                          </div>
                                         </div>
                                         ...
                                         <div class="col-md-4">
                                          ...
                                          <div id="form-group-name" class="form-group  ">
                                             ...
                                             <input  type="text" name="phone" value="<?php echo $rowclientclient['phone'];?>"  class="form-control form-control" placeholder="Phone"   >
                                          </div>
                                         </div>
                                         ...
                                         <div class="col-md-4">
                                           <div id="form-group-name" class="form-group  ">
                                             <label class="form-control-label" for="name">Status/Remark</label>
                                             <input   type="text" name="remark" value="<?php echo $rowclientclient['remark'];?>"  class="form-control form-control" placeholder="status/remark"    >
                                          </div>
                                         </div>
