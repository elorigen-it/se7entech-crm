            ...
            <div class="row">
               <div class="col-12">
                    ...
                    <div class="tab-content" id="tabs">
                        <div class="tab-pane fade show active" id="listzones" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
                                            ...
                                            <?php if(count($this->data['tasks'])):?>
                                                <?php foreach($this->data['tasks'] as $task):?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo $base_url;?>/modules/departments/index.php/<?php echo $task['id'];?>" class="btn btn-primary">Edit</a>
