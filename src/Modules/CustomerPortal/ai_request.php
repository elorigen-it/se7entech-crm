...
<html lang="es">
    <head>
        ...
        <title>Asistente de Requerimientos IA - Customer Portal</title>
    </head>
    <body class="">
        ...
        <div class="main-content">
            ...
            <div class="container-fluid mt--7">
                <div class="row">
                    <div class="col-12">
                        <div id="ai-request-chat-app"></div>
                    </div>
                </div>
            </div>
        ...
        <script>
            $(document).ready(function(){
                ...
                window.SE7ENTECH.request = <?php echo json_encode($this->data['request']);?>;
