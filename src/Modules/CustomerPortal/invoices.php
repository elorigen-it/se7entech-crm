    ...
    <body class="">
                ...
                <div class="container-fluid">
                    <div class="nav-wrapper">
                        <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="res_menagment" role="tablist"> 
                            <li class="nav-item">
                                <a class="nav-link mb-sm-3 mb-md-0 active" id="tabs-media-list" data-toggle="tab" href="#listinvoices" role="tab" aria-controls="tabs-menagment" aria-selected="false"><i class="fa fa-address-book-o mr-2"></i>My Invoices</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="tab-content" id="tabs">
                            <div class="tab-pane fade show active" id="listinvoices" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
                                <div class="card card-profile shadow">
                                    <div class="card-body" style="overflow-x:hidden;">
                                        <div id="invoices-app"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script>
            $(document).ready(function(){
                ...
                window.SE7ENTECH.invoices = <?php echo json_encode($this->data['invoices']);?>;
            });
        </script>        
    </body>
</html>
