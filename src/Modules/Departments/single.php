                ...
                <div class="container-fluid">
                    <div class="nav-wrapper">
                        <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="res_menagment" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link mb-sm-3 mb-md-0 active " id="tabs-menagment-main" data-toggle="tab" href="#addzone" role="tab" aria-controls="tabs-menagment" aria-selected="true"><i class="fa fa-user mr-2"></i>Updating department <?php echo $this->data['current']['name'];?></a>
                            </li>
                        </ul>
                    </div>
                </div>
                                    ...
                                    <div class="pl-lg-4">       
                                        <form id="postzone" method="POST">
                                            <div class="row">
                                                <div class="col-md-6">
                                                   <div class="form-group  ">
                                                        ...
                                                        <input value="<?php echo $this->data['current']['name'];?>" type="text" id="department-name" name="department-name" placeholder="Example: Marketing" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                   <div class="form-group  ">
                                                        ...
                                                        <select class="form-control" id="department-responsible" name="department-responsible">
                                                            ...
                                                            <?php foreach($this->data['users'] as $user):?>
                                                                <option value="<?php echo $user['id'];?>" <?php echo isset($this->data['current']['responsible_id']) ? ($this->data['current']['responsible_id'] === $user['id'] ? 'selected' : '') : '';?> >
                                            ...
                                            <div class="text-center">
                                                <button type="submit" name="save" value="1" class="btn btn-primary">Update Department</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
