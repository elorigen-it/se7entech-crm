                    ...
                    <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="res_menagment" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link mb-sm-3 mb-md-0 active " id="tabs-menagment-main" data-toggle="tab"
                                href="#addzone" role="tab" aria-controls="tabs-menagment" aria-selected="true"><i
                                    class="fa fa-user mr-2"></i>Updating User
                                <?php echo $this->data['current']['first_name'] . ' ' . $this->data['current']['last_name']; ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link mb-sm-3 mb-md-0" id="tabs-api-main" data-toggle="tab" href="#apikey"
                                role="tab" aria-controls="tabs-api" aria-selected="false"><i
                                    class="fa fa-key mr-2"></i>API Access</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="tab-content" id="tabs">
                        <!-- Tab Managment -->
                        <div class="tab-pane fade show active" id="addzone" role="tabpanel"
                                        ...
                                        <form id="postUser" method="POST" enctype="multipart/form-data">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div id="form-group-name" class="form-group  ">
                                                        ...
                                                        <input type="text" name="firstname"
                                                            value="<?php echo $this->data['current']['first_name']; ?>"
                                                            class="form-control form-control" placeholder="Agent's Name"
                                                            required>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div id="form-group-name" class="form-group  ">
                                                        ...
                                                        <input type="text" name="lastname"
                                                            value="<?php echo $this->data['current']['last_name']; ?>"
                                                            class="form-control form-control"
                                                            placeholder="Agent's Surname" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div id="form-group-name" class="form-group  ">
                                                        ...
                                                        <input disabled type="text" name="email"
                                                            value="<?php echo $this->data['current']['email']; ?>"
                                                            class="form-control form-control"
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div id="form-group-name" class="form-group  ">
                                                        ...
                                                        <input type="text" name="phone"
                                                            value="<?php echo $this->data['current']['mobile']; ?>"
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div id="form-group-name" class="form-group  ">
                                                        ...
                                                        <input type="text" name="address"
                                                            value="<?php echo $this->data['current']['address']; ?>"
                                                            class="form-control form-control" placeholder="Address"
                                                            required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div id="form-group-name" class="form-group  ">
                                                        ...
                                                        <input type="text" name="designation"
                                                            value="<?php echo $this->data['current']['designation']; ?>"
                                                            class="form-control form-control" placeholder="Designation"
                                                            required>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div id="form-group-name" class="form-group  ">
                                                        <label class="form-control-label" for="smtp_user">Corporate
                                                            Email</label>
                                                        <input type="text" name="smtp_user"
                                                            value="<?php echo $this->data['current']['smtp_user']; ?>"
                                                            class="form-control form-control"
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div id="form-group-name" class="form-group  ">
                                                        <label class="form-control-label" for="smtp_pass">Corporate
                                                            Password</label>
                                                        <input type="text" name="smtp_pass"
                                                            value="<?php echo $this->data['current']['smtp_pass']; ?>"
                                                            class="form-control form-control"
                                                ...
                                                <div class="col-md-4">
                                                    <div id="form-group-name" class="form-group  ">
                                                        ...
                                                        <img width="50" height="50"
                                                            src="<?php echo $this->data['current']['avatar']; ?>">
                                ...
                                <div class="card-body">
                                    <?php if (!empty($this->data['current']['api_key'])): ?>
                                        <div class="form-group">
                                            ...
                                            <small class="text-muted"><i class="fa fa-lock"></i> Keep this key secure. Do
                                                not share it publicly.</small>
                                        </div>

                                        <div class="alert alert-warning mt-4 shadow-sm"
                                            style="color: #634304; background-color: #fff3cd; border: 1px solid #ffeeba;">
                                            <div class="d-flex align-items-center">
                                                <span class="alert-inner--icon mr-2"><i
                                                        class="fa fa-exclamation-triangle fa-lg"></i></span>
                                                <span class="alert-inner--text"><strong>Warning:</strong> Revoking or
                                                    regenerating the key will invalidate the current one immediately. All
                                                    applications using this key will stop working.</span>
                                            </div>
                                        </div>
                                    ...
                                    <?php else: ?>
                                        <div class="text-center py-5">
                                            <div class="mb-4">
                                                <span
                                                    class="icon icon-shape bg-gradient-info text-white rounded-circle shadow-lg"
