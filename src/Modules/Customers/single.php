                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input value="<?php echo htmlspecialchars($this->data['current']['mega_upload_link'] ?? ''); ?>" type="url" id="mega_upload_link" name="mega_upload_link" class="form-control" placeholder="https://mega.nz/...">
                                                        </div>
                                                    </div>
                                                </div>
